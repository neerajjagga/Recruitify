        ...
        <div>
            <main>
                <div className="container pt-12 lg:pt-24 pb-10 overflow-hidden">
                    ...
                    {/* About Us */}
                    <div>
                        <div className='flex flex-col items-start mt-10 gap-5 lg:flex-row'>
                    ...
                    <div>
                        <div className='mt-16 flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col items-start gap-3'>
                                ...
                                <div className='btn-bg-primary rounded-2xl px-2 text-xs lg:text-sm font-medium font-Roboto py-1'>
